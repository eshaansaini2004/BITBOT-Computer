...
set in 50,				// Set RAM[0] = 2 //should not write because load is 0
set load 1,				// write must  succeed
set address 1,				// out remains -1
tick,
output;
tock,
output;
...
// Write to Screen[8191] - last address in Screen memory
set in -5,
set load 1,
set address -24577,
tick,
